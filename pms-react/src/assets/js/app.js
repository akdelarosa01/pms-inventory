...
window.screen.width < 1025
    ...
    : window.screen.width < 1340 && (document.getElementsByTagName("body")[0].classList.remove("enlarge-menu-all"), document.getElementsByTagName("body")[0].classList.add("enlarge-menu")),
        ...
        e.href == o &&
            ...
            e.parentElement.parentElement.classList.contains("navbar-nav") ||
                ((o = e.closest(".collapse")) &&
                    ...
                    (a = o.parentElement.querySelector("a")).classList.remove("collapsed"),
                    a.setAttribute("aria-expanded", "true"),
                    (a = o.parentElement.closest(".collapse")) && (a.classList.add("show"), a.parentElement.querySelector("a").classList.remove("collapsed"), a.parentElement.childNodes[1].setAttribute("aria-expanded", "true")))),
    ...
    if (e) {
        ...
        n &&
            ...
            (t = getClosest(n, ".parent-menu-item"))
                ? (t.classList.add("active"), (a = t.querySelector(".menu-item")) && a.classList.add("active"), (a = getClosest(t, ".parent-parent-menu-item")) && a.classList.add("active"))
                : (a = getClosest(n, ".parent-parent-menu-item")) && a.classList.add("active"));
    }
}
[].forEach.call(dropdowns, function (t) {
    ...
    document.querySelectorAll(".menu-body a").forEach(function (e, t) {
        ...
        e.href == a &&
            ...
            n.parentNode.querySelector(".nav-link")?.setAttribute("aria-expanded", "true"),
            n.parentNode.parentNode.parentNode.classList.add("show"),
            n.parentNode.parentNode.parentNode.parentNode.classList.add("menuitem-active"),
            n.parentNode.parentNode.parentNode.parentNode.querySelector(".nav-link")?.setAttribute("aria-expanded", "true"),
            "sidebar-menu" !== (e = n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode).getAttribute("id") && e.classList.add("show"),
            n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.classList.add("menuitem-active"),
            n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.querySelector(".nav-link")?.setAttribute("aria-expanded", "true"),
            (a = n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode) && a instanceof HTMLElement && "wrapper" !== a.getAttribute("id") && a.classList.add("show"),
            (e = (e = n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode) && e.parentNode) && e.classList.add("menuitem-active"));
    }),
        ...
        (document.querySelectorAll("#navigation li a").forEach(function (e, t) {
            ...
            if (e.href == a) {
                ...
                r.parentNode.parentNode.classList.add("active"),
                    r.parentNode.parentNode.parentElement.querySelector(".nav-link")?.classList.add("active"),
                    r.parentNode.parentNode.parentNode.parentNode.classList.add("active"),
                    r.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.classList.add("active");
            }
        }),
